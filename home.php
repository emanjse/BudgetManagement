...
<body class="d-flex flex-column flex-lg-row ">
    ...
    <section class="body-content mt-3">
        <div class="header-content d-flex align-items-center justify-content-between ">
            ...
            //user can see the expenses of a specific month and a year.
        ...
        <div
            class="welcome-content d-flex  flex-column flex-md-row align-items-center  align-items-md-start justify-content-between">
